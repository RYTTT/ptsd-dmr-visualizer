...
export const MDMA_KEY_GENES: KeyGeneItem[] = [
  {
    ...
    categoryBg: '#f5f3ff',
    finding: 'Protein arginylation locus prioritized for inspection in the timepoint-specific meta-analysis. Compare the three study components before interpreting direction or consistency.',
  },
  {
    gene: 'AHRR',
    ...
    categoryColor: '#1d4ed8',
    categoryBg: '#eff6ff',
    finding: 'Exposure-sensitive locus prioritized for timepoint-specific meta-analysis inspection. Study estimates can differ in direction and require smoking and environmental-confounder context.',
  },
  {
    gene: 'NR3C1',
    category: 'Glucocorticoid Receptor',
    categoryColor: '#6d28d9',
    categoryBg: '#f5f3ff',
    finding: 'HPA-axis receptor prioritized for timepoint-specific meta-analysis inspection. Compare the meta estimate with each study before biological interpretation.',
  },
  {
    gene: 'BDNF',
    ...
    categoryColor: '#047857',
    categoryBg: '#ecfdf5',
    finding: 'Neuroplasticity candidate included for timepoint-specific meta-analysis inspection. Observational methylation differences do not establish a driver of clinical recovery.',
  },
  {
    gene: 'HOXB9',
    ...
    categoryColor: '#0891b2',
    categoryBg: '#ecfeff',
    finding: 'Developmental transcription factor included for timepoint-specific meta-analysis inspection. Review each study and visit before interpreting generalizability.',
  },
  {
    gene: 'GNAS',
    ...
    categoryBg: '#ecfdf5',
    finding: 'G-protein signaling locus included for timepoint-specific meta-analysis inspection. “Restoration” requires a prespecified healthy reference and longitudinal contrast.',
  },
];

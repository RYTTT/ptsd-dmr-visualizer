...
export const MDMA_KEY_GENES: KeyGeneItem[] = [
  ...
  {
    gene: 'ACIN1',
    category: 'Epigenetic Stability',
    categoryColor: '#b91c1c',
    categoryBg: '#fef2f2',
    finding: 'Apoptotic chromatin condensation inducer 1. Chromatin structure regulator identified as a key differential DMR in therapy responder cohorts.',
    statsLabel: '40 EPIC Probes | Top 3 Fisher FDR < 1e-20',
    direction: 'Hypomethylated',
  },
  {
    gene: 'FKBP5',
